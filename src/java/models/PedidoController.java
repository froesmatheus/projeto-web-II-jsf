...
import models.util.JsfUtil.PersistAction;
...
public class PedidoController implements Serializable {
    ...
    @EJB
    private models.PedidoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/BundlePedido").getString("PedidoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/BundlePedido").getString("PedidoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/BundlePedido").getString("PedidoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
        ...
        if (selected != null) {
            ...
            try {
                ...
                if (msg.length() > 0) {
                    ...
                    JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("/BundlePedido").getString("PersistenceErrorOccured"));
                }
            } catch (Exception ex) {
